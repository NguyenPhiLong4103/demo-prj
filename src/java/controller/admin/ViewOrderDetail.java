...
public class ViewOrderDetail extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector<OrderDetail> vector = dao.getAllOrder(Integer.parseInt(oid));
//        Vector<OrderDetail> vector = dao.getAllOrder(8);
        request.setAttribute("ordDetail", vector);
        request.getRequestDispatcher("./jspAdmin/OrderDetail.jsp").forward(request, response);
    }
