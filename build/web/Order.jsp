                    ...
                    <div class="col-md-12 order-details">
                        ...
                        <div class="order-summary">
                            <table border="2">
                                <thead>
                                    <tr>
                                        <th style="padding: 0 10px 0 10px">Order Id</th>
                                        <th style="padding: 0 10px 0 10px">User Id</th>
                                        <th style="padding: 0 10px 0 10px">Order date</th>
                                        <th style="padding: 0 10px 0 10px">Total</th>
                                        <th style="padding: 0 10px 0 10px">Status</th>
                                    </tr>
                                </thead>
                                <tbody>
