    ...
    <body>
        <div id="logreg-forms">
            <form action="Register" method="post">
                ...
                <input name="uname" type="text" class="form-control" placeholder="User name" required="" autofocus="">
                <input name="email" type="email" class="form-control" placeholder="Email address" required autofocus="">
                <input name="phone" type="tel" class="form-control" placeholder="Phone" required autofocus="">
